...
- Spec content → `/to-spec`, or the supervised adapter's **gated** semantic amendment (writer matrix) (create or delta), committed alone at the
  gate.
...
Dual-harness note: in an AGENTS.md-based repo this content dissolves
into the root `AGENTS.md` (the always-loaded surface both engines
share); this file ships for Claude-pure installs.
